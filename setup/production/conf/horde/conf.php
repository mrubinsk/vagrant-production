...
$conf['auth']['params']['query_auth'] = 'SELECT * FROM mailbox WHERE email = \L AND password = \P';
$conf['auth']['params']['query_add'] = 'INSERT INTO mailbox (email, password) VALUES (\L, \P)';
$conf['auth']['params']['query_getpw'] = 'SELECT password FROM mailbox WHERE email = \L';
$conf['auth']['params']['query_update'] = 'UPDATE mailbox SET email = \L, password = \P WHERE email = \O';
$conf['auth']['params']['query_resetpassword'] = 'UPDATE mailbox SET password = \P WHERE email = \L';
$conf['auth']['params']['query_remove'] = 'DELETE FROM mailbox WHERE email = \L';
$conf['auth']['params']['query_list'] = 'SELECT email FROM mailbox';
$conf['auth']['params']['query_exists'] = 'SELECT 1 FROM mailbox WHERE email = \L';
...
$conf['vfs']['params']['vfsroot'] = '/horde/data/vfs';
$conf['vfs']['type'] = 'File';
